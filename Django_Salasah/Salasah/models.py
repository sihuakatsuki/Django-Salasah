...
class Produk(models.Model):
    ...
    kategori = models.OneToOneField(Kategori, on_delete=models.CASCADE)
    bahan = models.OneToOneField(Bahan, on_delete=models.CASCADE)
    berat = models.IntegerField(null=True)
    varian = models.ManyToManyField(Varian)
